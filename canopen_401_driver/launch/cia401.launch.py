...
"""Simple launch file for the Cia401Driver.

Targets a CiA 401 generic I/O device -- defaults match the IMET M880 radio
...
argument:
    ...
    ros2 launch canopen_401_driver cia401.launch.py \
