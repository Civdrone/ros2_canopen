#ifndef CANOPEN_408_DRIVER__LIFECYCLE_CIA408_DRIVER_HPP_
#define CANOPEN_408_DRIVER__LIFECYCLE_CIA408_DRIVER_HPP_
...
class LifecycleCia408Driver : public ros2_canopen::LifecycleCanopenDriver
{
  std::shared_ptr<node_interfaces::NodeCanopen408Driver<rclcpp_lifecycle::LifecycleNode>> impl_;

public:
  explicit LifecycleCia408Driver(rclcpp::NodeOptions node_options = rclcpp::NodeOptions());
...
#endif  // CANOPEN_408_DRIVER__LIFECYCLE_CIA408_DRIVER_HPP_
