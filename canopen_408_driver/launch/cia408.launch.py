...
"""Simple launch file for the Cia408Driver against a CiA 408 fluid-power device
(Danfoss PVE-CC electrohydraulic valve).

Expects bus.yml, master.dcf, and the per-slave .bin file(s) to live in a single
directory (default /data/ros2_canopen). Override with launch arguments:

    ros2 launch canopen_408_driver cia408.launch.py \
